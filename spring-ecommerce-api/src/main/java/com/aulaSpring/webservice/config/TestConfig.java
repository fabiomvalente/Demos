package com.aulaSpring.webservice.config;
...
import com.aulaSpring.webservice.entities.OrderStatus;
import com.aulaSpring.webservice.entities.Payment;
...
import com.aulaSpring.webservice.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        userRepository.saveAll(List.of(u1, u2));  //Arrays.asList(u1, u2)
